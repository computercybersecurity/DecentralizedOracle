...
contract Oracle is Ownable, OracleInterface, Reputation, SelectionDEOR {
  ...
  function getReputationStatus () external view override(OracleInterface) returns (uint256, uint256, uint256, uint256)
  {
  ...
  {
    requests.push(Request(currentId, _urlToQuery, _requestMethod, _requestBody, _attributeToFetch, "", block.timestamp, 0));
